    ...
    <div>
      ...
      <div className="flex flex-col justify-center -mt-2">
        <div className="flex justify-between items-center gap-4 mb-4">
          ...
          <div className="flex flex-col items-center bg-black text-white p-2 w-15  ">
            <h5 className="">2</h5>
            <h5 className="">min</h5>
          </div>
        </div>
        <div className="bg-gray-200 w-full h-1 mb-3"></div>
        <div className="flex justify-between items-center mb-4"> 
          <img
            className="h-25 w-30 self-center "
          ...
          <div className="text-right">
                <h4 className="text-xl uppercase">Santh</h4>
                <h2 className="font-bold text-2xl">KA15AK00-0</h2>
        ...
        <button className="bg-black text-white rounded-lg text-xl px-3 py-2">Cancel Ride</button>
      </div>
    </div>
  );
};
