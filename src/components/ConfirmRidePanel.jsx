  ...
  return (
    <div>
      ...
      <div className='flex flex-col  justify-center p-5'>
        <h4 className="text-3xl font-bold mb-6">Confirm your ride</h4>
        ...
        <div className='flex flex-col gap-3 mt-4 mb-4'>
            <div className='flex items-center justify-start gap-3 border-b-4 border-gray-300 py-3 '>
                <h4>
                <i class="text-lg ri-map-pin-4-fill"></i></h4>
                <div  >
            ...
            <div className='flex items-center justify-start gap-3 border-b-4 border-gray-300 py-3  '>
            <h4>
            <i class="text-lg ri-square-fill"></i></h4>
                <div  >
            ...
            <h4>
            <i class="text-lg ri-currency-fill"></i></h4>
            <div  >
          ...
          <button onClick={()=>{
           ...
           className='bg-green-400 w-full font-semibold px-3 py-2 rounded-lg text-xl text-white'>Confirm</button>
